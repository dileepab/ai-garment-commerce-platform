...
export const config = {
  matcher: [
     ...
     * - login page
     */
    '/((?!api/auth|api/webhooks|api/storefront|api/catalog/meta|api/content/creatives/[^/]+/image|api/cron|size-charts|_next/static|_next/image|favicon\\.ico|sitemap\\.xml|robots\\.txt|login).*)',
  ],
};
